			 ...
			 <div class="layui-form-item" style="width:1280px;height:auto;padding:0px; margin:0 auto;" id="main"">
				...
				<div class="layui-form-item">
			 	...
			 	<div class="layui-form-item">
					 ...
					 <div class="layui-inline" style="left:29px;width: 512px;top:-50px;">
					 ...
					 <div class="layui-inline" style="width: 512px;top:-50px;">
						...
						<button class="layui-btn" data-type="reload" type="button" id="do_search" style="margin-top: -105px;margin-left: -47px;">搜索</button>
