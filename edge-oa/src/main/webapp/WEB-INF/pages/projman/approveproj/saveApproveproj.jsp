		...
		<input type="hidden" id="fjsx" name="fjsx"> 
			 ...
			 <div class="layui-form-item">
				  <div class="layui-inline" style="left: -98px;">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" name="budget_Amount" lay-verify="budget_Amount" autocomplete="off" class="layui-input" id="budget_Amount" onchange="ysje()">
			    ...
			    <div class="layui-inline" style="top: -10px;left: -14px;">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" name="plan_Cont_Date" id="date" lay-verify="date" placeholder="yyyy-mm-dd" autocomplete="off" class="layui-input">
				      </div>
			    </div>
			  </div>
			...
			<div class="layui-form-item">
				<div class="layui-inline" style="width: 608px;left: -158px;">
				  ...
				  <div class="layui-inline" style="top: -2px;left: -196px;">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" name="cust_Contact" lay-verify="cust_Contact" autocomplete="off" class="layui-input" id="cust_Contact">
				      </div>
			    </div>
		  </div>
			...
			<div class="layui-form-item">
			    ...
			    <div class="layui-input-block" style="left: -8px;">
			      <input type="text" name="cust_Unit" lay-verify="cust_Unit" autocomplete="off" placeholder="请输入客户单位名称" class="layui-input" style="width: 51.5%" id="cust_Unit">
			    </div>
		  </div>
		  ...
		  <div class="layui-form-item">
			  <div class="layui-inline" style="top: -2px;left: -122px;">
			      ...
			      <div class="layui-input-inline">
			        <input type="text" name="cust_Phone" lay-verify="cust_Phone" autocomplete="off" class="layui-input" id="cust_Phone">
			      </div>
		    </div>
			  <div class="layui-inline" style="top: -2px;left: 9px;">
			      <label class="layui-form-label" style="width: 95px;">客户固定电话</label>
			      <div class="layui-input-inline">
			        <input type="text" name="offi_Tel" lay-verify="offi_Tel" autocomplete="off" class="layui-input" id="offi_Tel">
			      </div>
		    </div>
		  </div>
			 ...
			 <div class="layui-form-item">
				  <div class="layui-inline" style="top: -2px;left: -166px;">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" name="proj_Succ_Rate" lay-verify="proj_Succ_Rate" autocomplete="off" class="layui-input" id="proj_Succ_Rate">
				        <span style="position: relative;top: -25px;right: -105px;">%</span>
				      </div>
			    </div>
				  <div class="layui-inline" style="width: 417px;left: -120px;top: -10px;">
			 ...
			 <div class="layui-form-item">
				    ...
				    <div class="layui-input-block" style="left: -10px;">
				      <input type="text" name="our_Unit" lay-verify="our_Unit" autocomplete="off" placeholder="请输入我方单位名称" class="layui-input" style="width: 51.8%" id="our_Unit">
				    </div>
			  </div>
			 ...
			 <div class="layui-form-item layui-form-text">
			    ...
			    <div class="layui-input-block">
			      <textarea placeholder="请输入内容" name="memo_1"  lay-verify="memo_1" id="memo_1" class="layui-textarea" style="width:51.6%"></textarea>
			    </div>
			 </div>
...
function ysje(){
	//获得预算金额输入的值
	var ysje=$('#budget_Amount').val()*1;
	if(ysje!=""){
		var je=ysje.toFixed(2); 
		$('#budget_Amount').val(je);
	}else{
		$('#budget_Amount').val("0.00");
	}
}
</script>
</body>
