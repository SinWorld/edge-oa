			...
			<div class="layui-form-item">
			 	<div class="layui-inline" style="left:10px;">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" name="hyjydh" lay-verify="hyjydh" autocomplete="off" class="layui-input" id="hyjydh" value="${hyjy.hyjydh}">
				      </div>
			    </div>
				...
				<div class="layui-inline" style="left:30px;">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" name="hyzt" lay-verify="hyzt" autocomplete="off" class="layui-input" id="hyzt" value="${hyjy.hyzt}">
				      </div>
			    </div>
		 	...
		 	<div class="layui-form-item">
			 	<div class="layui-inline" style="left:10px;">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" name="cyry" lay-verify="cyry" autocomplete="off" class="layui-input" id="cyry" value="${hyjy.cyry}">
				      </div>
			    </div>
				...
				<div class="layui-inline" style="left:60px;">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" name="beginTime" id="beginTime" lay-verify="beginTime" placeholder="yyyy-mm-dd" autocomplete="off" class="layui-input" value="${kssj}">
				      </div>
			    </div>
			    ...
			    <div class="layui-inline" style="left:48px;">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" name="endTime" id="endTime" lay-verify="endTime" placeholder="yyyy-mm-dd" autocomplete="off" class="layui-input" value="${jssj}">
				      </div>
			    </div>
			 ...
			 <div class="layui-form-item layui-form-text">
			    ...
			    <div class="layui-input-block">
			      <textarea placeholder="请输入内容" name="bz"  lay-verify="bz" id="bz" class="layui-textarea" style="width:840px;">${hyjy.bz}</textarea>
			    </div>
			</div>
