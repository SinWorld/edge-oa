...
<body onload="refreshAndClose()" style="width:100%;padding:0px; margin:0px;">
	<div style="width:1280px;height:auto;padding:0px; margin:0 auto;" id="main">
		<form class="layui-form" action='<c:url value="/hyjy/saveHyjy.do"/>' method="post" id="myForm" style="margin-top:30px;">
			...
			<div class="layui-form-item">
			 	<div class="layui-inline" style="left:10px;">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" name="hyjydh" lay-verify="hyjydh" autocomplete="off" class="layui-input" id="hyjydh">
				      </div>
			    </div>
				...
				<div class="layui-inline" style="left:30px;">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" name="hyzt" lay-verify="hyzt" autocomplete="off" class="layui-input" id="hyzt">
				      </div>
			    </div>
		 	...
		 	<div class="layui-form-item">
			 	<div class="layui-inline" style="left:10px;">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" name="cyry" lay-verify="cyry" autocomplete="off" class="layui-input" id="cyry">
				      </div>
			    </div>
				...
				<div class="layui-inline" style="left:60px;">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" name="beginTime" id="beginTime" lay-verify="beginTime" placeholder="yyyy-mm-dd" autocomplete="off" class="layui-input">
				      </div>
			    </div>
			 ...
			 <div class="layui-form-item layui-form-text">
			    ...
			    <div class="layui-input-block">
			      <textarea placeholder="请输入内容" name="bz"  lay-verify="bz" id="bz" class="layui-textarea" style="width:840px;"></textarea>
			    </div>
			</div>
