...
<body onload="refreshAndClose()" style="width:100%;padding:0px; margin:0px;">
	<div style="width:1280px;height:auto;padding:0px; margin:0 auto;" id="main">
		<form class="layui-form" action='<c:url value="/bqwh/saveBqwh.do"/>' method="post" id="myForm" style="margin-top:70px;">
			...
			<div class="layui-form-item">
			 	<div class="layui-inline" style="width: 600px;left: 250px;">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" name="bqwhbh" lay-verify="bqwhbh" autocomplete="off" class="layui-input" id="bqwhbh" style="width:400px;">
				      </div>
			    </div>
			</div>
			...
			<div class="layui-form-item">
				 <div class="layui-inline"  style="width: 600px;left: 250px;">
					      ...
					      <div class="layui-input-inline">
					        <input type="text" name="bqwhdh" lay-verify="bqwhdh" autocomplete="off" class="layui-input" id="bqwhdh" style="width:400px;">
					      </div>
				  </div>
			</div>
			...
			<div class="layui-form-item">
				   <div class="layui-inline"  style="width: 600px;left: 250px;">
					      ...
					      <div class="layui-input-inline">
					        <input type="text" name="bqwhmc" lay-verify="bqwhmc" autocomplete="off" class="layui-input" id="bqwhmc" style="width:400px;">
					      </div>
				    </div>
			</div>
