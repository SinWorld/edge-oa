...
<body onload="refreshAndClose()" style="width:100%;padding:0px; margin:0px;">
	<div style="width:1280px;height:auto;padding:0px; margin:0 auto;" id="main">
		<form class="layui-form" action='<c:url value="/kh/saveKh.do"/>' method="post" id="myForm" style="margin-top:100px;">
			...
			<div class="layui-form-item">
			 	<div class="layui-inline" style="left:30px;">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" name="khdh" lay-verify="khdh" autocomplete="off" class="layui-input" id="khdh">
				      </div>
			    </div>
				...
				<div class="layui-inline" style="left:30px;">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" name="khjc" lay-verify="khjc" autocomplete="off" class="layui-input" id="khjc">
				      </div>
			    </div>
			  ...
			  <div class="layui-inline" style="left:30px;">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" name="khmc" lay-verify="khmc" autocomplete="off" class="layui-input" id="khmc">
				      </div>
			    </div>
			 ...
			 <div class="layui-form-item layui-form-text">
			    ...
			    <div class="layui-input-block">
			      <textarea placeholder="请输入内容" name="khms"  lay-verify="khms" id="khms" class="layui-textarea" style="width:858px;"></textarea>
			    </div>
			</div>
