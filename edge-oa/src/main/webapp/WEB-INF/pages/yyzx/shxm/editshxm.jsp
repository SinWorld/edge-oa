...
<body onload="refreshAndClose()" style="width:100%;padding:0px; margin:0px;">
	<div style="width:1280px;height:auto;padding:0px; margin:0 auto;" id="main">
		<form class="layui-form" action='<c:url value="/shxm/editSHXM.do"/>' method="post" id="myForm" style="margin-top:30px;">
			<input type="hidden" id="url" value='<c:url value="/"/>'>
			<input type="hidden" id="flag" value="${flag}"> 
			<input type="hidden" value="${shxm.shxm_kh}" id="kh">
			<input type="hidden" value="${shxm.shxm_qyzt}" id="qyzt">
			<input type="hidden" value="${shxm.shxm_dm}" name="shxm_dm">
			
			<div class="layui-form-item">
			 	<div class="layui-inline" style="left:10px;">
				      <label class="layui-form-label" style="width: 120px;">售后项目代号</label>
				      <div class="layui-input-inline">
				        <input type="text" name="shxm_dh" lay-verify="shxm_dh" autocomplete="off" class="layui-input" id="shxm_dh" value="${shxm.shxm_dh}">
				      </div>
			    </div>
				...
				<div class="layui-inline" style="left:30px;">
				      ...
				      <div class="layui-input-inline" style="width: 500px;">
				        <input type="text" name="shxm_mc" lay-verify="shxm_mc" autocomplete="off" class="layui-input" id="shxm_mc" style="width: 485px;" value="${shxm.shxm_mc}">
				      </div>
			    </div>
			 ...
			 <div class="layui-form-item layui-form-text">
			    ...
			    <div class="layui-input-block">
			      <textarea placeholder="请输入内容" name="shxm_ms"  lay-verify="shxm_ms" id="shxm_ms" class="layui-textarea" style="width:840px;">${shxm.shxm_ms}</textarea>
			    </div>
			</div>
...
layui.use(['form', 'layedit', 'laydate'], function(){
  ...
  function loadqyzt(form){
	  //获得签约主体下拉选
	  var qyzts=$('#shxm_qyzt').find('option');
	  //获得已选签约主体下拉选主键
	  var qyzt=$('#qyzt').val();
