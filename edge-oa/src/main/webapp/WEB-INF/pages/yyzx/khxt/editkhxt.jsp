			...
			<div class="layui-form-item">
			 	<div class="layui-inline" style="left:10px;">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" name="khxt_dh" lay-verify="khxt_dh" autocomplete="off" class="layui-input" id="khxt_dh" value="${khxt.khxt_dh}">
				      </div>
			    </div>
				...
				<div class="layui-inline" style="left:30px;">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" name="khxt_mc" lay-verify="khxt_mc" autocomplete="off" class="layui-input" id="khxt_mc" value="${khxt.khxt_mc}">
				      </div>
			    </div>
		 	...
		 	<div class="layui-form-item">
			 	<div class="layui-inline" style="left:10px;">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" name="khxt_khbm" lay-verify="khxt_khbm" autocomplete="off" class="layui-input" id="khxt_khbm" value="${khxt.khxt_khbm}">
				      </div>
			    </div>
				...
				<div class="layui-inline" style="left:40px;">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" name="khxt_khfzr" id="khxt_khfzr" lay-verify="khxt_khfzr"  autocomplete="off" class="layui-input" value="${khxt.khxt_khfzr}">
				      </div>
			    </div>
			    ...
			    <div class="layui-inline" style="left:28px;">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" name="khxt_sxrq" id="khxt_sxrq" lay-verify="khxt_sxrq" placeholder="yyyy-mm-dd" autocomplete="off" class="layui-input" value="${khxt.sxrq}">
				      </div>
			    </div>
			 ...
			 <div class="layui-form-item layui-form-text">
			    ...
			    <div class="layui-input-block">
			      <textarea placeholder="请输入内容" name="khxt_bz"  lay-verify="khxt_bz" id="khxt_bz" class="layui-textarea" style="width:840px;">${khxt.khxt_bz}</textarea>
			    </div>
			</div>
