...
<body onload="refreshAndClose()" style="width:100%;padding:0px; margin:0px;">
	<div style="width:1280px;height:auto;padding:0px; margin:0 auto;" id="main">
		<form class="layui-form" action='<c:url value="/xmxx/editXMXX.do"/>' method="post" id="myForm" style="margin-top:30px;">
			<input type="hidden" id="url" value='<c:url value="/"/>'>
			<input type="hidden" id="flag" value="${flag}">
			<input type="hidden" id="khdm" value="${xmxx.xmxx_kh}">
			<input type="hidden" id="fzr" value="${xmxx.xmxx_fzr}">
			<input type="hidden" value="${xmxx.xmxx_dm}" name="xmxx_dm">  
			
			<div class="layui-form-item">
			 	<div class="layui-inline" style="left:10px;">
				      <label class="layui-form-label" style="width: 120px;">预算编号</label>
				      <div class="layui-input-inline">
				        <input type="text" name="xmxx_ysbh" lay-verify="xmxx_ysbh" autocomplete="off" class="layui-input" id="xmxx_ysbh" value="${xmxx.xmxx_ysbh}">
				      </div>
			    </div>
				...
				<div class="layui-inline" style="left:30px;">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" name="xmxx_dh" lay-verify="xmxx_dh" autocomplete="off" class="layui-input" id="xmxx_dh" value="${xmxx.xmxx_dh}">
				      </div>
			    </div>
			    ...
			    <div class="layui-inline" style="left:30px;">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" name="xmxx_mc" lay-verify="xmxx_mc" autocomplete="off" class="layui-input" id="xmxx_mc" value="${xmxx.xmxx_mc}">
				      </div>
			    </div>
		 	...
		 	<div class="layui-form-item">
				...
				<div class="layui-inline" style="left:60px;">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" name="xmxx_jhkssj" id="xmxx_jhkssj" lay-verify="xmxx_jhkssj" placeholder="yyyy-mm-dd" autocomplete="off" class="layui-input" value="${xmxx.jhkssj}">
				      </div>
			    </div>
			    ...
			    <div class="layui-inline" style="left:48px;">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" name="xmxx_jhjssj" id="xmxx_jhjssj" lay-verify="xmxx_jhjssj" placeholder="yyyy-mm-dd" autocomplete="off" class="layui-input" value="${xmxx.jhjssj}">
				      </div>
			    </div>
			 ...
			 <div class="layui-form-item">
				 ...
				 <div class="layui-inline" style="left:55px;">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" name="xmxx_khbm" lay-verify="xmxx_khbm" autocomplete="off" class="layui-input" id="xmxx_khbm" value="${xmxx.xmxx_khbm}">
				      </div>
			    </div>
			    ...
			    <div class="layui-inline" style="left:55px;">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" name="xmxx_khfzr" lay-verify="xmxx_khfzr" autocomplete="off" class="layui-input" id="xmxx_khfzr" value="${xmxx.xmxx_khfzr}">
				      </div>
			    </div>
			  ...
			  <div class="layui-form-item">
			 	...
			 	<div class="layui-inline" style="left:40px;">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" name="xmxx_tcrq" id="xmxx_tcrq" lay-verify="xmxx_tcrq" placeholder="yyyy-mm-dd" autocomplete="off" class="layui-input" value="${xmxx.tcrq}">
				      </div>
			    </div>
				 ...
				 <div class="layui-inline" style="left:60px;">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" name="xmxx_xmje" lay-verify="xmxx_xmje" autocomplete="off" class="layui-input" id="xmxx_xmje" onchange="xmjeChange()" value="${xmxx.xmxx_xmje}">
				      </div>
			    </div>
			    ...
			    <div class="layui-inline" style="left:60px;">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" name="xmxx_yjgzl" lay-verify="xmxx_yjgzl" autocomplete="off" class="layui-input" id="xmxx_yjgzl" onchange="yjgzlChange()" value="${xmxx.xmxx_yjgzl}">
				      </div>
			    </div>
			 ...
			 <div class="layui-form-item layui-form-text">
			    ...
			    <div class="layui-input-block">
			      <textarea placeholder="请输入内容" name="xmxx_bz"  lay-verify="xmxx_bz" id="xmxx_bz" class="layui-textarea" style="width:880px;">${xmxx.xmxx_bz}</textarea>
			    </div>
			</div>
