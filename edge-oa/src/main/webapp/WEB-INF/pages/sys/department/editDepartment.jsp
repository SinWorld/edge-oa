...
<body onload="refreshAndClose()">
	<div
		...
		<form class="layui-form" action="<c:url value='/department/editDepartment.do'/>"
			method="post">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 56.5%;">
					<select name="dep_parentid" id="provinces" lay-filter="provinces" lay-verify="provinces">
						<option value="${department.dep_parentid}">${depName}</option>
					</select>
				</div>
			</div>
			...
			<div class="layui-form-item" style="margin-bottom: 0px;">
				...
				<div class="layui-input-block">
					<input type="text" name="dep_name" lay-verify="username"
						...
						id="userName" placeholder="请输入部门名称" value="${department.dep_name}"> <span id="clearUserName" class="close"><i
			...
			<div class="layui-form-item layui-form-text">
				...
				<div class="layui-input-block">
					<textarea placeholder="请输入内容" lay-verify="role_infor"
						class="layui-textarea" style="width: 56.5%" name="dep_description">${department.dep_description}</textarea>
				</div>
			</div>
