...
<body onload="refreshAndClose()">
	<div style="margin-top: 70px; margin-left: auto; margin-right: auto; width: auto;">
		<form class="layui-form" action="<c:url value='/role/editRole.do'/>" method="post">
			<div class="layui-form-item" style="margin-bottom:15px;">
				<input type="hidden" id="flag" value="${flag}">
				<label class="layui-form-label" style="width: 125px;">角色名称</label>
				<div class="layui-input-block">
					<input type="hidden" name="role_id" value="${role.role_id}">
					<input type="text" name="role_name" lay-verify="username" autocomplete="off" class="layui-input" style="width: 56.5%"
						id="userName" placeholder="请输入角色名称" value="${role.role_name}"> 
				</div>
			</div>
			...
			<div class="layui-form-item layui-form-text">
				...
				<div class="layui-input-block">
					<textarea placeholder="请输入内容" lay-verify="role_infor"
						class="layui-textarea" style="width: 56.5%" name="role_infor">${role.role_infor}</textarea>
				</div>
			</div>
