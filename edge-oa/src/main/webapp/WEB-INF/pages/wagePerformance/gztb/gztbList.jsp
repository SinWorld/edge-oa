...
<body>
	<form class="layui-form" action="" style="margin-top: 10px;">
	 <div class="demoTable" style="background-color: #CAE1FF;height:155px;" id="gjssq">
			...
			<div class="layui-form-item">
		 	...
		 	<div class="layui-form-item">
				...
				<div class="layui-inline" style="width:329px;top:-52px;left:26px;">
		 		...
		 		<div class="layui-inline" style="left:12px;top: -50px;">
				      <label class="layui-form-label" style="width: 71px;">当前操作</label>
				      <div class="layui-input-inline">
					     <input type="text" name="nextCz" lay-verify="nextCz" autocomplete="off" class="layui-input" style="width:192px;" id="nextCz">
					  </div>
				 </div>
			 	<button type="reset" class="layui-btn layui-btn-primary" style="margin-left:21px;margin-top: -105px;">重置</button>
			</div>
		</div> 
	</div>
</form>
...
layui.use(['table','form','layedit', 'laydate'], function(){
  ...
  table.on('toolbar(test)', function(obj){
    var url=$('#url').val();
    var flag=$('#flag').val();
    var address="/wage/initSaveWage.do";
    		...
    		success : function(data) {
    			if(data.flag){
    				layer.open({
    		      		...
    		      		resize:false,
    		      	    anim: 1,
    		      	  	content:[url+"wage/initSaveWage.do",'yes']
    		    	 });
    			}else{
