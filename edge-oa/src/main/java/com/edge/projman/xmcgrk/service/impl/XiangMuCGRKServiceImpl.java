...
public class XiangMuCGRKServiceImpl implements XiangMuCGRKService {
	...
	public List<XmrkInFo> queryAllXmrkInFo(Xmcgrk_QueryVo vo) {
		return xiangMuCGRKDao.queryAllXmrkInFo(vo);
	}

	// 查询不重复的uuid
	public List<String> queryUUId() {
		return xiangMuCGRKDao.queryUUId();
	}

	// 按条件查询项目采购入库所有数量
	public Integer queryAllXmrkInFoCount(Xmcgrk_QueryVo vo) {
		return xiangMuCGRKDao.queryAllXmrkInFoCount(vo);
	}
