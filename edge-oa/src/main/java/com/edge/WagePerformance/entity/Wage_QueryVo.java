...
public class Wage_QueryVo {
	...
	public String toString() {
		return "Wage_QueryVo [page=" + page + ", size=" + size + ", startRow=" + startRow + ", wage_Code=" + wage_Code
				...
				+ ", wage_Yglx=" + wage_Yglx + ", wage_Tbr=" + wage_Tbr + ", appr_Status=" + appr_Status + ", nextCz="
				+ nextCz + "]";
	}
